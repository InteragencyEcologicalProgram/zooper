...
zoop_eml<-make_eml(
  ...
  data.table.url=c("https://www.dropbox.com/s/639y0ee2qoz6b02/zooplankton_community.csv?dl=1",
                   "https://www.dropbox.com/s/sghl5n7v7po9hd1/zooplankton.csv?dl=1",
                   "https://www.dropbox.com/s/jakuafrisx6ayz7/environment.csv?dl=1",
                   "https://www.dropbox.com/s/pbua78vrgsd86dx/taxonomy.csv?dl=1",
                   "https://www.dropbox.com/s/ps2pzhj8mvkvlox/taxa_lists.csv?dl=1",
                   "https://www.dropbox.com/s/p4gig4g7mmampzx/undersampled.csv?dl=1",
                   "https://www.dropbox.com/s/e03xhgo6dq07n1l/stations.csv?dl=1",
                   "https://www.dropbox.com/s/l29wt8nhs0oi9dc/study_metadata.csv?dl=1",
                   "https://www.dropbox.com/s/hnvc9t1jhsk26d2/biomass_mesomicro.csv?dl=1"),
  other.entity = "Data_processing.R",
  other.entity.name = "Data processing code",
  other.entity.description = paste0("R code used to process data created with the R package zooper (v",
                                    packageVersion("zooper"), ") into the format published here. Data processing mostly involved removing duplicative variables"),
  other.entity.url = "https://www.dropbox.com/s/27npjzjyisqzlkg/Data_processing.R?dl=1",
  user.domain = "EDI",
  user.id="sbashevkin",
  return.obj=TRUE,
  #write.file=FALSE,
