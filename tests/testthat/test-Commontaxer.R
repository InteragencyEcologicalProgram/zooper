...
SourceTaxaKey <- tibble::tibble(
  ...
  Lifestage = c("Adult", "Larva", "Juvenile", "Adult", "Adult", "Egg",
                "Adult", "Larva", "Juvenile", "Larva", "Juvenile", "Adult",
                "Adult", "Larva", "Juvenile", "Juvenile", "Juvenile", "Adult"),
  SizeClass = "Micro",
...
test_that("Commontaxer returns correct output", {
  expect_equal(Commontax, tibble::tibble(Taxname=c("Acartiella sinensis", "Acartiella sinensis", "Pseudodiaptomus marinus"), Lifestage = c("Adult", "Larva", "Adult")))
})
