...
#'
#' This function returns an integrated zooplankton dataset with taxonomic issues resolved, according to user-specifications, along with important caveats about the data. It requires the output of the \code{Zoopdownloader} function to run. This can be provided either as a list or paths to saved .Rds files generated by the \code{Zoopdownloader} function.
